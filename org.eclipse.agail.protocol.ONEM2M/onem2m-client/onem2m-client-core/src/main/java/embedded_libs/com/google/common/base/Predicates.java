...
package embedded_libs.com.google.common.base;

import static embedded_libs.com.google.common.base.Preconditions.checkNotNull;

import embedded_libs.com.google.common.annotations.Beta;
import embedded_libs.com.google.common.annotations.GwtCompatible;
import embedded_libs.com.google.common.annotations.GwtIncompatible;
...
import embedded_libs.javax.annotation.Nullable;
...
public final class Predicates {
  ...
  public static <T> Predicate<T> and(Predicate<? super T> first, Predicate<? super T> second) {
    return new AndPredicate<T>(Predicates.<T>asList(Preconditions.checkNotNull(first), Preconditions.checkNotNull(second)));
  }
  ...
  public static <T> Predicate<T> or(Predicate<? super T> first, Predicate<? super T> second) {
    return new OrPredicate<T>(Predicates.<T>asList(Preconditions.checkNotNull(first), Preconditions.checkNotNull(second)));
  }
