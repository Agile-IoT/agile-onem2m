...
public class Om2mProtocol extends AbstractAgileObject implements Protocol {

    private final Logger LOGGER = LoggerFactory.getLogger(Om2mProtocol.class);

    private static final String AGILE_OM2M_PROTOCOL_BUS_NAME = "org.eclipse.agail.protocol.OM2M";

    private static final String AGILE_OM2M_PROTOCOL_BUS_PATH = "/org/eclipse/agail/protocol/OM2M";
     ...
     * Protocol name
     */
    private static final String PROTOCOL_NAME = "om2M";

    private static final String RUNNING = "RUNNING";

    private static final String DRIVER_NAME = "OM2M";
    ...
    public Om2mProtocol() {
        try {
            dbusConnect(AGILE_OM2M_PROTOCOL_BUS_NAME, AGILE_OM2M_PROTOCOL_BUS_PATH, this);
    ...
    private void initDevices() {
        ...
        this.resourceMappersByApplicationId.forEach((id, resourceMapper) -> {
            ...
            thingsDataMap.forEach((key, thing) -> {
                ...
                DeviceOverview deviceOverview = new DeviceOverview(thing.getId(), AGILE_OM2M_PROTOCOL_BUS_NAME, thing.getName(), CONNECTED);
    ...
    public String getName() {
        return AGILE_OM2M_PROTOCOL_BUS_NAME;
    }
